...
// HandleFunc is an adapter which allows the usage of an http handler
// request handle.
func HandleFunc(method, path string, handler func(w http.ResponseWriter, r *http.Request)) error {
